<x-app-layout>
    ...
    <div x-data="{section: 'import'}">
        ...
        <button @click="section = 'import'" :class="section === 'import' ? 'text-blue-600' : 'text-gray-800'"
                class="mr-4">
            <i class="fa-solid fa-cloud-arrow-up text-lg mr-0.5"></i>
            Import
        </button>

        <button :class="section === 'export' ? 'text-blue-600' : 'text-gray-800'" @click="section = 'export'"
                class="mr-4">
            <i class="fa-solid fa-cloud-arrow-down text-lg mr-0.5"></i>
            Export
        </button>

        <button :class="section === 'my-imports' ? 'text-blue-600' : 'text-gray-800'"
