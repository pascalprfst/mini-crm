<form @submit.prevent="submitForm" x-data="addNewField" class="mt-4">
    ...
    <div>
        <div class="text-sm text-slate-600 relative mt-4 my-2">
            Auswahlmöglichkeiten
        </div>

        <input type="text" required id="fieldname" name="fieldname"
               class="w-full rounded-md border-slate-300 py-1.5"/>

        <div
            class="text-sm text-slate-500 font-medium items-center flex justify-center cursor-pointer py-1.5 hover:text-slate-700 mt-2">
