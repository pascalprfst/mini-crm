<div x-data="{open: true}" x-cloak :class="open ? 'w-72' : 'w-12'"
     class="h-screen bg-neutral-100 relative transition-all duration-200 ease-in-out border-r border-r-neutral-300 shadow-sm">
    <i @click="open = !open"
    ...
    <nav class="mt-16 px-2">
        <ul>
            ...
            <li>
                <a class="flex items-center cursor-pointer hover:bg-neutral-50 px-2 h-10 rounded-md mb-2.5">
